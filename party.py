...
def is_mel(name, email):
    """Is this user Mel?  Identifies Mel by name, email or both.

    For example:

    >>> is_mel("Amelia Bedelia", "mel@ubermelon.com")
    True
    >>> is_mel("Mel Melitpolski","mel@ubermelon.com")
    True
    >>> is_mel("Somebody Else", "someone@gmail.com")
    False
    >>> is_mel("Mel Melitpolski", "nomail@mail.com")
    True
    """

    return "melitpolski" in name.lower() or email.lower() == "mel@ubermelon.com"
...
def most_and_least_common_type(treats):
    ...
    In case of a tie, it will return the item that appeared first on the list.
